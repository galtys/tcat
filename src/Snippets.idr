...
renderSchemaDataAsJsonP {schema = (IField name FInt)} item = printf """ {"%s":%d} """ name (int2integer item)
...
renderSchemaDataAsJsonP1 {schema = (IField name FInt)} item = printf """ %d """  (int2integer item)
...
json2Schema2Data (IField name FInt) x = integer_to_int (list_json_to_num x)
